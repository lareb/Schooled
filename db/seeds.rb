...
users_seed = [
  ...
  school_id: 1, role: 2, accepted: true, phone_number: "0885955926"},
  {name: 'Велико Колев',
  email: 'kolev@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 1, accepted: true, phone_number: "0885955926"},
  ...
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 1, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Александър Петров',
  email: 'alex@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 2, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Ангел Димитров',
  email: 'acho@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 3, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Димитър Петров',
  email: 'mitko@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 4, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Ива Милушева',
  email: 'iva@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 5, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Марта Благоева',
  email: 'marta@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 6, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Блага Димитрова',
  email: 'blaga@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 7, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Лариса Вергиева',
  email: 'lary@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 8, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Петьо Даулджиев',
  email: 'pepi@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 9, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Марин Горнишки',
  email: 'marin@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 10, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'катерина Маринова',
  email: 'katy@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 11, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Михаил Божилов',
  email: 'mihail@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 12, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Боряна Конова',
  email: 'buba@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 13, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Кати Маринова',
  email: 'katty@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 14, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Веселин Гешев',
  email: 'veselin@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 15, address: "София", accepted: true, phone_number: '0873499771'},
  {name: 'Любомир Рангачев',
  email: 'lubo96@example.com', password: 'password',
  password_confirmation: 'password', admin: false,
  school_id: 1, role: 0, group_id: 1, number: 16, address: "София", accepted: true, phone_number: '0873499771'}
]
